...
const UI_STRINGS = {
  en: {
    ...
    spkNoRecogBody: 'You can still record yourself and compare with the model voice. We won\u2019t invent an accuracy score without a recogniser \u2014 you\u2019ll rate yourself instead. On iPhone or iPad, scoring works in Safari only; Chrome, Firefox and Edge there cannot reach the recogniser. On Android, use Chrome.',
    ...
    spkInsecureTitle: 'Microphone needs a secure (https) address',
    spkInsecureBody: 'This page is being served over plain http, and phone browsers only allow the microphone on https. Open the site at an https:// address and the speaking test will score normally. A LAN address such as http://192.168.0.10:8000 will not work on a phone, even though it works on a computer at localhost.',
    spkPreparing: 'Getting the microphone ready\u2026',
    spkSwitchedSelfCheck: 'Switched to self-check so you can still finish: record yourself, compare with the model, and rate it.',
    spkErrInsecure: 'The microphone is blocked because this page isn\u2019t served over https.',
    ...
    anatomyLede: 'Choose a female or male model, then explore the front, back or face. Tap a point or a word to learn its English name, Thai meaning and pronunciation.',
    anatomyFront: 'Front', anatomyBack: 'Back', anatomyFace: 'Face',
    anatomyPrompt: 'Select a numbered point or a word in the list.',
  ...
  th: {
    ...
    spkNoRecogBody: 'คุณยังบันทึกเสียงตัวเองและเทียบกับเสียงตัวอย่างได้ เราจะไม่สร้างคะแนนขึ้นมาเองหากไม่มีระบบถอดเสียง คุณจะเป็นผู้ประเมินตนเองแทน บน iPhone หรือ iPad การให้คะแนนใช้ได้เฉพาะใน Safari เท่านั้น (Chrome, Firefox และ Edge บน iOS ใช้ไม่ได้) ส่วนบน Android ให้ใช้ Chrome',
    ...
    spkInsecureTitle: 'ไมโครโฟนต้องใช้ที่อยู่แบบปลอดภัย (https)',
    spkInsecureBody: 'หน้านี้เปิดผ่าน http ธรรมดา เบราว์เซอร์บนมือถืออนุญาตให้ใช้ไมโครโฟนเฉพาะบน https เท่านั้น กรุณาเปิดเว็บไซต์ผ่านที่อยู่ https:// แล้วแบบทดสอบการพูดจะให้คะแนนได้ตามปกติ ที่อยู่ในวงแลน เช่น http://192.168.0.10:8000 จะใช้บนมือถือไม่ได้ แม้จะใช้ได้บนคอมพิวเตอร์ที่ localhost',
    spkPreparing: 'กำลังเตรียมไมโครโฟน…',
    spkSwitchedSelfCheck: 'เปลี่ยนเป็นโหมดประเมินตนเองเพื่อให้ทำต่อจนจบได้: บันทึกเสียงตัวเอง เทียบกับเสียงตัวอย่าง แล้วให้คะแนน',
    spkErrInsecure: 'ไมโครโฟนถูกบล็อกเนื่องจากหน้านี้ไม่ได้เปิดผ่าน https',
    ...
    anatomyLede: 'เลือกแบบจำลองผู้หญิงหรือผู้ชาย แล้วสำรวจด้านหน้า ด้านหลัง หรือใบหน้า แตะจุดหรือคำศัพท์เพื่อเรียนชื่อภาษาอังกฤษ ความหมายภาษาไทย และการออกเสียง',
    anatomyFront: 'ด้านหน้า', anatomyBack: 'ด้านหลัง', anatomyFace: 'ใบหน้า',
    anatomyPrompt: 'เลือกจุดหมายเลขบนภาพหรือคำศัพท์ในรายการ',
